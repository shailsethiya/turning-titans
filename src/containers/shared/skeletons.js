...
export const NestedListSkeleton = (props) => (
  <ContentLoader viewBox="0 0 250 110" height="7vw" width="15vw" {...props}>
...
export const CardSkeleton = (props) => (
  <ContentLoader viewBox="10 0 50 20" height="15vw" width="20vw" {...props}>
